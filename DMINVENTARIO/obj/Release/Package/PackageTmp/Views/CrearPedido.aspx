<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CrearPedido.aspx.cs" Inherits="DMINVENTARIO.Views.CrearPedido" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	...
	<br />
	<asp:Label runat="server" ID="Error1" CssClass="control-label" style="color:red"></asp:Label>
    <br />
    ...
    <div class="row">
            <div class="form-group">
                <label for="lblDepartment" class="control-label col-sm-1 ">Conversion</label>
				<div class="col-sm-3">
					<asp:DropDownList runat="server" ID="DropMoneda" CssClass="form-control" OnSelectedIndexChanged="DropMoneda_SelectedIndexChanged" AutoPostBack="true">
                ...
                <%--<label for="lblDepartment" class="control-label col-sm-1 ">Crear Pedido en Softland</label>--%>
				<div class="col-sm-3">
				...
				<div class="col-sm-4">
                    ...
                    &nbsp&nbsp
                    <asp:Button runat="server" ID="BtnGuardarEncabezado" OnClick="BtnGuardarEncabezado_Click" CssClass="btn btn-warning" Text="Finalizar Pedido" />
                </div>
            </div>
        </div>
    <br />
      <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <dx:ASPxGridView ID="GridLineas" runat="server" KeyFieldName="ID" OnInit="GridLineas_Init" Width="257px" AutoGenerateColumns="False" Theme="Office2010Black" OnRowDeleting="GridLineas_RowDeleting" OnRowUpdating="GridLineas_RowUpdating">
                    <SettingsAdaptivity>
                    ...
                    <EditFormLayoutProperties ColCount="2">
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataTextColumn FieldName="PEDIDO" VisibleIndex="1">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="ARTICULO" VisibleIndex="2">
                            </dx:GridViewDataTextColumn>
                            <dx:GridViewDataTextColumn FieldName="DESCRIPCION" VisibleIndex="3" PropertiesTextEdit-MaxLength="20">
                            <PropertiesTextEdit MaxLength="20" EncodeHtml="false"></PropertiesTextEdit>
                            </dx:GridViewDataTextColumn>
